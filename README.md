...
"dependencies": {
  "com.aim4code.nanoserviceflow": "0.4.1"
}
```
...
```json
"dependencies": {
  "com.aim4code.nanoserviceflow": "https://github.com/aim4code/nanoserviceflow.git#v0.4.1"
}
```

> [!IMPORTANT]
> **Version Determinism:** Notice the `#v0.4.1` at the end of the URL. If you omit the version tag, Unity will resolve the dependency using the latest commit on the default branch at the time of checkout. As the branch updates, this can lead to team members having different versions of the package installed, breaking version determinism. Always lock your Git dependencies to a specific release tag.
>
